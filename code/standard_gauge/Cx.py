...
s_e_C1_1_ss = Train(
    **COMMON_C1_PROPS,
    ...
    additional_text=grf.fake_vehicle_info({
        ...
        'Builder': 'ASEA, ASJ',
        'Trivia': '''Stockholm's first metro stock. The first unit was equipped with a pantograph''',
    }),
)
...
s_e_C3_1_ss = Train(
    **COMMON_C3_PROPS,
    ...
    additional_text=grf.fake_vehicle_info({
        ...
        'Use': 'Sockholm Metro trains',
        'Builder': 'ASEA, ASJ',
        'Trivia': '''The C3 lacked cabs and were therefore always sandwiched  between other units''',
    }),
)
