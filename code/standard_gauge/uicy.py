...
d_p_bn_4_dsb = Train(
    **COMMON_b_PROPS,
    ...
    country='denmark',
    company='na',
    purchase_sprite_towed_id='d_p_bn_4_dsb',
...
d_p_bn_5_dsb = Train(
    **COMMON_b_PROPS,
    ...
    country='denmark',
    company='na',
    purchase_sprite_towed_id='d_p_bn_5_dsb',
...
d_p_bn_6_dsb = Train(
    **COMMON_b_PROPS,
    ...
    country='denmark',
    company='na',
    purchase_sprite_towed_id='d_p_bn_6_dsb',
...
d_p_an_2_dsb = Train(
    **COMMON_b_PROPS,
    ...
    country='denmark',
    company='na',
    purchase_sprite_towed_id='d_p_an_2_dsb',
    introduction_date=date(1991, 1, 1),
    weight=40,
    cargo_capacity=64,
    loading_speed=15,
...
d_p_an_3_dsb = Train(
    **COMMON_b_PROPS,
    ...
    country='denmark',
    company='na',
    purchase_sprite_towed_id='d_p_an_3_dsb',
    introduction_date=date(1991, 1, 1),
    weight=37,
    cargo_capacity=48,
    loading_speed=15,
...
fr_p_a_1_sncf = Train(
    **COMMON_b_PROPS,
    ...
    country='france',
    company='na',
    purchase_sprite_towed_id='fr_p_a_1_sncf',
...
fr_p_a_2_sncf = Train(
    **COMMON_b_PROPS,
    ...
    country='france',
    company='na',
    purchase_sprite_towed_id='fr_p_a_2_sncf',
    introduction_date=date(1971, 1, 1),
    weight=42,
    cargo_capacity=54,
    loading_speed=10,
...
fr_p_a_3_sncf = Train(
    **COMMON_b_PROPS,
    ...
    country='france',
    company='na',
    purchase_sprite_towed_id='fr_p_a_3_sncf',
...
fr_p_ab_1_sncf = Train(
    **COMMON_b_PROPS,
    ...
    country='france',
    company='na',
    purchase_sprite_towed_id='fr_p_ab_1_sncf',
    introduction_date=date(1969, 1, 1),
    weight=42,
    cargo_capacity=64,
    loading_speed=10,
...
fr_p_ab_2_sncf = Train(
    **COMMON_b_PROPS,
    ...
    country='france',
    company='na',
    purchase_sprite_towed_id='fr_p_ab_2_sncf',
    introduction_date=date(1971, 1, 1),
    weight=42,
    cargo_capacity=64,
    loading_speed=10,
...
fr_p_ab_3_sncf = Train(
    **COMMON_b_PROPS,
    ...
    country='france',
    company='na',
    purchase_sprite_towed_id='fr_p_ab_3_sncf',
    introduction_date=date(1979, 1, 1),
    weight=42,
    cargo_capacity=64,
    loading_speed=10,
...
fr_p_b_1_sncf = Train(
    **COMMON_b_PROPS,
    ...
    country='france',
    company='na',
    purchase_sprite_towed_id='fr_p_b_1_sncf',
    introduction_date=date(1964, 1, 1),
    weight=42,
    cargo_capacity=80,
    loading_speed=10,
...
fr_p_b_2_sncf = Train(
    **COMMON_b_PROPS,
    ...
    country='france',
    company='na',
    purchase_sprite_towed_id='fr_p_b_2_sncf',
    introduction_date=date(1971, 1, 1),
    weight=42,
    cargo_capacity=80,
    loading_speed=10,
...
fr_p_b_3_sncf = Train(
    **COMMON_b_PROPS,
    ...
    country='france',
    company='na',
    purchase_sprite_towed_id='fr_p_b_3_sncf',
    introduction_date=date(1979, 1, 1),
    weight=42,
    cargo_capacity=80,
    loading_speed=10,
...
fr_p_ad_1_sncf = Train(
    **COMMON_b_PROPS,
    ...
    country='france',
    company='na',
    purchase_sprite_towed_id='fr_p_ad_1_sncf',
    introduction_date=date(1968, 1, 1),
    weight=42,
    cargo_capacity=42,
    loading_speed=10,
...
fr_p_ad_2_sncf = Train(
    **COMMON_b_PROPS,
    ...
    country='france',
    company='na',
    purchase_sprite_towed_id='fr_p_ad_2_sncf',
    introduction_date=date(1971, 1, 1),
    weight=42,
    cargo_capacity=42,
    loading_speed=10,
...
fr_p_ad_3_sncf = Train(
    **COMMON_b_PROPS,
    ...
    country='france',
    company='na',
    purchase_sprite_towed_id='fr_p_ad_3_sncf',
    introduction_date=date(1979, 1, 1),
    weight=42,
    cargo_capacity=56,
    loading_speed=10,
...
fr_p_bd_1_sncf = Train(
    **COMMON_b_PROPS,
    ...
    country='france',
    company='na',
    purchase_sprite_towed_id='fr_p_bd_1_sncf',
    introduction_date=date(1972, 1, 1),
    weight=42,
    cargo_capacity=40,
    loading_speed=10,
...
fr_p_bd_2_sncf = Train(
    **COMMON_b_PROPS,
    ...
    country='france',
    company='na',
    purchase_sprite_towed_id='fr_p_bd_2_sncf',
    introduction_date=date(1979, 1, 1),
    weight=42,
    cargo_capacity=40,
    loading_speed=10,
