...
s_w_Gblssy_2_gc = Train(
    ...
    callbacks={
        'cargo_capacity': Train.sw_capacity_calculaiton(22.4, g)
    }
)
...
s_w_Hbis_sj = Train(
    ...
    callbacks={
        'cargo_capacity': Train.sw_capacity_calculaiton(25, g)
    }
)
...
(g.add(lib.SetPurchaseOrder(
    ...
    grf.VariantGroup('HLD 202/203', be_d_202_2_nmbs, be_d_202_1_nmbs, be_d_202_3_nmbs, be_d_202_4_nmbs),
    grf.VariantGroup('HLD 204', be_d_202_6_nmbs, be_d_202_5_nmbs, be_d_202_7_nmbs, be_d_202_8_nmbs),
    be_d_205_1,
    # bg
    # bg electric 25
    ...
    grf.VariantGroup('њMS/MB', d_d_ms_1_dsb, d_d_mb_1_dsb),
    d_d_mki_1_dsb,
    grf.VariantGroup('њMA', d_d_ma_1_dsb, d_d_ma_2_dsb, d_d_ma_3_dsb, d_d_ma_4_dsb, d_d_ma_5_dsb, d_d_ma_6_dsb, d_d_ma_7_dsb, d_d_ma_8_dsb, d_d_ma_9_dsb, d_d_ma_10_dsb, d_d_ma_11_dsb, d_d_ma_12_dsb),
    grf.VariantGroup('Y-Tog "Lynette" "Grisen"', d_d_y1_1_dsb, d_d_y1dvt_1_dsb, d_d_y2_1_dsb, d_d_y2_2_dsb, d_d_y3_1_dsb, d_d_y4_1_dsb, d_d_y6_1_dsb, d_d_y6_4_dsb, d_d_y6_2_dsb, d_d_y6_5_dsb, d_d_y6_3_dsb, d_d_y8_1_dsb, d_d_y8_2_dsb, d_d_y8_3_dsb, d_d_y8_4_dsb, d_d_y9_1_dsb, d_d_y9_3_dsb, d_d_y9_2_dsb),
    ...
    grf.VariantGroup('40s local stock', d_p_cl_1_dsb, d_p_cl_9_dsb, d_p_cl_10_dsb, d_p_cl_11_dsb, d_p_cl_8_dsb, d_p_cl_7_dsb, d_p_cl_2_dsb, d_p_cl_3_dsb, d_p_cl_5_dsb),
    ...
    grf.VariantGroup('њX31K/ET/X32K (Øresundståg)', d_e_et_1_dsb, d_e_et_1_sj, d_e_et_2_sj, d_e_et_2_dsb),
    s_e_x60_1_sj,
